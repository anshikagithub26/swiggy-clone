...
function Navbar() {
  ...
  return (
    <>
    <div className="text-3xl w-full sticky bg-white z-40 top-0 shadow-md h-20 flex justify-center items-center">
      <div className=' w-[70%] flex justify-between'>
        <div className='flex items-center'>
         <Link to={"/"}> <img className='w-10' src="https://w7.pngwing.com/pngs/55/100/png-transparent-swiggy-hd-logo-thumbnail.png" alt="" /></Link>
